...
namespace CadCafeteria_G4
{
    ...
    public partial class LabCafeteria_G4Entities : DbContext
    {
        public LabCafeteria_G4Entities()
            : base("name=LabCafeteria_G4Entities")
        {
        }
        ...
        public virtual ObjectResult<paVentaBuscar_Result> paVentaBuscar(Nullable<int> parametro)
        {
            var parametroParameter = parametro.HasValue ?
                new ObjectParameter("parametro", parametro) :
                new ObjectParameter("parametro", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paVentaBuscar_Result>("paVentaBuscar", parametroParameter);
        }
    
        public virtual ObjectResult<paVentaDetalleBuscar_Result> paVentaDetalleBuscar(Nullable<int> parametro)
        {
            var parametroParameter = parametro.HasValue ?
                new ObjectParameter("parametro", parametro) :
                new ObjectParameter("parametro", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paVentaDetalleBuscar_Result>("paVentaDetalleBuscar", parametroParameter);
        }
    
        public virtual ObjectResult<paVentaDetalleListar_Result> paVentaDetalleListar()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paVentaDetalleListar_Result>("paVentaDetalleListar");
        }
